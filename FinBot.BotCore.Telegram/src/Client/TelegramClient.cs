...
using FinBot.BotCore.Telegram.Exceptions;
...
namespace FinBot.BotCore.Telegram.Client {
    public class TelegramClient : ITelegramClient {
        ...
        public async Task<MessageInfo> UpdateMessage(UpdateMessageData data,
            CancellationToken cancellationToken = new CancellationToken()) {

            return await SendRequestAsync<MessageInfo>("editMessageText", data, cancellationToken);
        }

        public async Task<bool> AnswerCallbackQuery(AnswerCallbackQueryData data, 
            CancellationToken cancellationToken = new CancellationToken()) {
            
            return await SendRequestAsync<bool>("answerCallbackQuery", data, cancellationToken);
        }
